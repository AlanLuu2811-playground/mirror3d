...
# Clone from "https://github.com/facebookresearch/detectron2/blob/main/tools/deploy/export_model.py"
...
from mirror3d_lib import Mirror3d_GeneralizedRCNN
...
def setup_cfg(args):
    ...
    # MODEL
    cfg.ANCHOR_NORMAL_NYP = f'{args.data_dir}/kmeans_normal_10.npy'
    cfg.MODEL.WEIGHTS = args.model_weights
    cfg.ANCHOR_NORMAL_CLASS_NUM = np.load(cfg.ANCHOR_NORMAL_NYP).shape[0]

    # DATASET
    cfg.VAL_COCO_JSON = f'{args.data_dir}/valid_annot.json'
    cfg.VAL_IMG_ROOT = f'{args.data_dir}'
...
def export_tracing(torch_model, inputs):
    ...
    if isinstance(torch_model, Mirror3d_GeneralizedRCNN):
    ...
    if args.format != "torchscript":
        return None
    if not isinstance(torch_model, (Mirror3d_GeneralizedRCNN,)):
        return None
...
def main() -> None:
    ...
    torch_model = Mirror3dTrainer.build_model(cfg)
